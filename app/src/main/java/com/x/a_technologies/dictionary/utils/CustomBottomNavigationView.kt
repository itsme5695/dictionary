...
class CustomBottomNavigationView(val binding: ActivityMainBinding, val context: Context,
    ...
    init{
        ...
        binding.lastConstraint.setOnClickListener {
            navigationClickListener.click(binding.lastConstraint.id)
            setView(binding.lastImg, binding.lastSelector)
        }
    }
